...
نکته: معمولاً تنوع IP روی **IPv6** بیشتر است. حتی اگر سرور IPv6 نداشته باشد، WARP داخل تونل IPv6 می‌دهد؛ به همین دلیل `warp-multi ips` اول IPv6 را تست می‌کند و اگر در دسترس نبود، IPv4 را نشان می‌دهد.
